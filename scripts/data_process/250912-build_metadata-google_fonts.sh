...
python -m src.svg_glyph_gen_v2.extract_metadata_tags \
    ...
    --input_google_font_metadata_dir data/google_fonts/tags/ \
    --output_dir data/processed/google_font_metadata

python -m src.svg_glyph_gen_v2.filter_invalid_fonts \
    --input_metadata_jsonl data/processed/google_font_metadata/ \
    --input_google_font_dir data/google_fonts/ofl \
    --output_dir data/processed/google_font_metadata-filter_invalid

python -m src.svg_glyph_gen_v2.render_pangram_for_fonts \
    --input_metadata_jsonl data/processed/google_font_metadata-filter_invalid \
    --input_google_font_dir data/google_fonts/ofl \
    --output_dir data/processed/google_font_metadata-filter_invalid-pangram
...
python -m src.svg_glyph_gen_v2.filter_by_pangram_svg \
    --input_metadata_jsonl data/processed/google_font_metadata-filter_invalid \
    --input_pangram_jsonl data/processed/google_font_metadata-filter_invalid-pangram \
    --output_dir data/processed/google_font_metadata-filter_invalid-filter_by_pangram

# Filter fonts by lmm ocr
output_base_dir=data/processed/filter_fonts_by_lmm_ocr
...
# optimize svg
input_metadata_jsonl=data/processed/google_font_metadata-filter_invalid-filter_by_pangram
input_google_font_dir=data/google_fonts/ofl
...
python -m src.serve.decode_to_svg ${output_base_dir}/sft/
...
mv data/processed/google_font_metadata-filter_invalid-filter_by_pangram data/processed/.google_font_metadata-filter_invalid-filter_by_pangram
...
--output_dir data/processed/google_font_metadata-stat_field_values

python -m src.svg_glyph_gen_v2.stat_font_vertical \
--input_gfont_metadata data/processed/google_font_metadata-filter_invalid-filter_by_pangram-filtered_by_lmm_ocr \
--output_dir data/processed/google_font_metadata-stat_font_vertical \
--input_google_font_dir data/google_fonts/ofl

wait # there is a background process
echo -e "\033[32mFinish building metadata of google fonts\033[0m"
