...
output_dir=data/processed_envato/normalized_svg/
...
input_svg_dir=data/processed_envato/normalized_svg/
input_content_file=data/processed_envato/content/alphanumeric.txt
input_metadata_jsonl=data/processed_envato/metadata_in_gfont-filter_invalid-filter_by_pangram-filtered_by_lmm_ocr
...
# filter by token len
filtered_sft_base_dir=data/processed_envato/filtered_sft/250903-envato-alphanumeric/

# filter for alphanumeric.
max_token_len=2800 # NOTE: check it accroding to .../sft/*/stat_token_len/*train*.pdf, @ 99 %ile
split_name="train_font_family"
