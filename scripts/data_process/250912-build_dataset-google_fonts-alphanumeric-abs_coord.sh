...
output_dir=data/processed/normalized_svg-abs_coord
...
# build sft data
sft_base_dir=data/processed/sft/250910-alphanumeric-abs_coord/

input_svg_dir=data/processed/normalized_svg-abs_coord
split_names=(
  "train_font_family"
  "ood_font_family"
)
...
# filter by token len
filtered_sft_base_dir=data/processed/filtered_sft/250910-alphanumeric-abs_coord/

# filter for alphanumeric.
max_token_len=1600 # NOTE: check it accroding to .../sft/*/stat_token_len/*train*.pdf, @ 99 %ile
