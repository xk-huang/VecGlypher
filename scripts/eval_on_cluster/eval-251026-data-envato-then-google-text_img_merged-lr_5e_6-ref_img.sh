...
eval_on_cluster_name=eval-251026-data-envato-then-google-text_img_merged-lr_5e_6-ref_img
models_array=(
251026-data-envato-then-google-text_img_merged-lr_5e_6/gemma-3-27b-it-abs_coord-envato_fonts-num_epochs_3
251026-data-envato-then-google-text_img_merged-lr_5e_6/gemma-3-27b-it-envato_fonts-num_epochs_3
)
tp=2
dp=4
