...
STORAGE_MODEL_PATH="gt_copycat"
MODEL_PATH="saves/gt_copycat"
OUTPUT_DIR="/mnt/workspace/svg_glyph_llm/outputs/gt_copycat"
...
# Cannot compute those metrics as the gts and preds are the same.
# start img eval
